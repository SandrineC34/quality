      ...
      <form class="space-y-5" @submit.prevent="handleSubmit">
        ...
        <div>
          <div class="flex items-center justify-between mb-2">
            <label :class="UI.label + ' mb-0'">Actions correctives</label>
            <button
              type="button"
          ...
          <div
            ...
            <div class="grid grid-cols-3 gap-2">
              <div>
                <label :class="UI.labelSm">Pilote de l'action</label>
                <input v-model="action.pilote" type="text" placeholder="Nom du pilote" :class="UI.input" />
              </div>
              <div>
                <label :class="UI.labelSm">Date objectif de clôture</label>
              ...
              <div>
                <label :class="UI.labelSm">Vérification de l'efficacité</label>
                <textarea
                  v-model="action.efficacite"
                  rows="2"
                  placeholder="Vérification de l'efficacité"
                  :class="UI.textarea"
                ></textarea>
              </div>
